...
setInterval( function(){
  ...
  if(counter <= 1000000000000){
    ...
    var firstTxt = "I'm sorry, Ms. Manya. I am for real. Never meant to  make you cry. I apologize. ";
    
       var lastTxt = "I'm sorry, Ms. Manya. I am for real. Never meant to  make you cry. I apologize a trillion times.";
    
    var txt = "I'm sorry, Ms. Manya. I am for real. Never meant to  make you cry. I apologize " + counter + " times. ";
    var speed = 45;
